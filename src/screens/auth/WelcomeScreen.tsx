          ...
          <GlassCard style={styles.card}>
            ...
            <View style={styles.footer}>
              <Text style={styles.footerText}>
                ...
                <Text style={styles.footerLink} onPress={openTermsUrl}>{t('auth.footer.terms')}</Text>{' '}
                {t('auth.footer.and')}{' '}
                <Text style={styles.footerLink} onPress={openPrivacyUrl}>{t('auth.footer.privacy')}</Text>.
              </Text>
            </View>
          </GlassCard>
        </View>
