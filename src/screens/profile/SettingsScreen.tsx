              ...
              <GlassCard style={styles.settingCard}>
                <View style={styles.settingInfo}>
                  ...
                  <View style={styles.languageRow}>
                    ...
                    >
                      <Text style={[styles.languageChipText, locale === 'en' && styles.languageChipTextActive]}>{t('settings.language.en')}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={[styles.languageChip, locale === 'es' && styles.languageChipActive]}
                      onPress={() => setLocale('es')}
                    >
                      <Text style={[styles.languageChipText, locale === 'es' && styles.languageChipTextActive]}>{t('settings.language.es')}</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </GlassCard>
