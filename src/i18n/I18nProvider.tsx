...
const dictionaries: Record<SupportedLocale, Dictionary> = {
  en: {
    ...
    'actions.churchMessageNotPublishedBody': 'This week’s church message has not been published in-app yet.',
    ...
    'actions.audioUnavailableBody': 'Audio playback is not available in this build yet.',
    ...
    'auth.footer.terms': 'Terms of Use',
    'auth.footer.and': 'and',
    ...
    'legal.terms.s1.title': 'What MKP Is',
    'legal.terms.s1.body': 'MKP is a church-led spiritual formation app designed to help churches extend Sunday teaching into the week through reflection, formation, and care connection.',
    'legal.terms.s2.title': 'Not Emergency, Medical, or Crisis Care',
    'legal.terms.s2.body': 'MKP is not emergency response, therapy, medical care, or crisis intervention. If someone is in immediate danger or needs urgent help, contact local emergency services or another appropriate emergency resource.',
    'legal.terms.s3.title': 'Acceptable Use',
    'legal.terms.s3.body': 'You agree not to misuse MKP, interfere with the service, attempt unauthorized access, impersonate others, or use the app in a way that violates applicable law or the trust and safety of others.',
    'legal.terms.s4.title': 'Private Reflection and Church Submissions',
    'legal.terms.s4.body': 'Journal entries, mood notes, and private reflection text are designed to remain on your device as part of the intended product experience. If you intentionally submit a prayer request, support request, or other church-directed request, that submitted content may be shared with the connected church team for ministry follow-up.',
    'legal.privacy.title': 'Privacy Policy',
    'legal.privacy.s1.title': 'What Stays on Your Device',
    'legal.privacy.s1.body': 'Journal entries, mood notes, and reflection text are designed to remain on your device and not be stored on MKP backend infrastructure as part of the core product experience.',
    'legal.privacy.s2.title': 'Church Support Requests',
    'legal.privacy.s2.body': 'If you choose to send a prayer request, support request, gratitude note, or similar church-directed request through Care, that submitted content may be made available to your connected church team for follow-up. These submissions are not public and are not posted to a public prayer wall or community feed.',
    'legal.privacy.s3.title': 'Backups and Church Data',
    'legal.privacy.s3.body': 'Because local reflection content stays on your device, it may still be affected by your own device backup settings, such as iCloud Backup or Android device backup. Church data is intended to remain scoped to the relevant church context rather than shared across unrelated churches.',
    'legal.privacy.s4.title': 'Your Choices and MKP Boundaries',
    'legal.privacy.s4.body': 'You choose what you write privately on your own device and what you intentionally submit through church workflows. MKP is not designed as a public social platform, public prayer wall, or pastoral notes system.',
    ...
    'legal.openOnline': 'VIEW FULL VERSION ONLINE',
    ...
    'settings.language.comingSoon': 'Coming soon',
    'settings.language.supportedNote': 'English and Spanish are fully supported today. More languages will appear here once the app is fully translated.',
    ...
    'settings.care.messagesFeed': 'Church Messages Feed',
    'settings.care.messagesFeedHint': 'Read inbound-only church-wide updates and pastoral notices.',
    ...
    'settings.care.inbox': 'Care Inbox',
    'settings.care.inboxHint': 'Review private in-app care follow-up threads from your church team.',
    ...
    'care.home.nextStep': 'TAKE A NEXT STEP',
    ...
    'care.home.inbox': 'VIEW CARE INBOX',
    'care.home.messages': 'CHURCH MESSAGES',
    ...
    'care.support.type.unsure': 'I’m not sure what my next step is',
    'care.nextSteps.title': 'What next step would you like to take?',
    'care.nextSteps.section.type': 'CHOOSE A NEXT STEP',
    'care.nextSteps.section.message': 'YOUR NOTE',
    'care.nextSteps.section.messageOptional': 'YOUR NOTE (OPTIONAL)',
    'care.nextSteps.section.contact': 'FOLLOW-UP PREFERENCE',
    'care.nextSteps.placeholder': 'Share anything helpful for your church team...',
    'care.nextSteps.placeholderOptional': 'Anything you want your church to know (optional)...',
    'care.nextSteps.defaultMessage.new_believer': 'Recent salvation follow-up requested.',
    'care.nextSteps.defaultMessage.baptism_request': 'Baptism follow-up requested.',
    'care.nextSteps.defaultMessage.other': 'Next-step follow-up requested.',
    'care.nextSteps.send': 'SEND NEXT STEP',
    'care.nextSteps.sending': 'Sending your next step...',
    'care.nextSteps.error': 'Something went wrong. Your next step may not have sent.',
    'care.nextSteps.retry': 'TRY AGAIN',
    'care.nextSteps.saveLocal': 'SAVE LOCALLY',
    'care.nextSteps.saved.title': 'Saved on this device',
    'care.nextSteps.saved.body': 'Your next step is saved locally for now. You can submit it again later.',
    'care.nextSteps.contactNote': 'Follow-up stays in-app when available. Your church may also use your account email if needed.',
    ...
    'care.success.viewInbox': 'VIEW CARE INBOX',
    'care.success.returnHome': 'RETURN TO HOME',
    'care.success.submitPrayer': 'SUBMIT A PRAYER',
    'care.nextSteps.success.kicker': 'NEXT STEP',
    'care.nextSteps.success.title': 'Your next step was shared.',
    'care.nextSteps.success.message': 'Your church now has your next-step request and can follow up as their ministry flow allows.',
    'care.nextSteps.success.disclaimer': 'If you are in immediate danger, call local emergency services.',
    'care.nextSteps.success.returnHome': 'RETURN TO HOME',
    'care.nextSteps.success.submitPrayer': 'SUBMIT A PRAYER',
    'care.inbox.title': 'Care Inbox',
    'care.inbox.subtitle': 'Private follow-up from your church team will appear here.',
    'care.inbox.emptyTitle': 'No care threads yet.',
    'care.inbox.emptyBody': 'When you send a support request and choose in-app follow-up, your private thread will appear here.',
    'care.inbox.status.awaiting': 'Awaiting reply',
    'care.inbox.status.closed': 'Closed',
    'care.thread.sender.you': 'You',
    'care.thread.sender.church': 'Church Team',
    'care.thread.status.awaitingTitle': 'Awaiting a response',
    'care.thread.status.awaitingBody': 'When your church replies in-app, it will appear in this private thread.',
    'care.thread.status.closedTitle': 'Thread complete',
    'care.thread.status.closedBody': 'Your church has sent its single in-app response for this request.',
    'care.thread.oneReplyRule': 'One church reply keeps support focused and the app centered on formation.',
    'care.thread.missingTitle': 'Thread unavailable',
    'care.thread.missingBody': 'This care thread could not be found on this device.',
    'care.preference.encouragementOff': 'Encouragement replies are off in Settings, so this request will not open a private follow-up thread.',
    'churchMessages.title': 'Church Messages',
    'churchMessages.subtitle': 'Inbound-only pastoral notes, reminders, and church-wide updates appear here.',
    'churchMessages.offTitle': 'Church messages are paused.',
    'churchMessages.offBody': 'Turn on Church Messages in Settings when you want to receive church-wide broadcasts in the app.',
    'churchMessages.missingTitle': 'Message unavailable',
    'churchMessages.missingBody': 'This church message could not be opened right now.',
    'churchMessages.kind.pastoral': 'Pastoral Note',
    'churchMessages.kind.announcement': 'Announcement',
    'churchMessages.kind.reminder': 'Reminder',
    ...
    'journey.quick.insights': 'WEEKLY INSIGHTS',
    'journey.quick.awareness': 'MOOD RHYTHM',
    'journey.search.placeholder': 'Search reflections, moods, or sermons',
    'journey.search.empty': 'No entries match this search yet.',
    'journey.pastAwareness.title': 'Past Awareness',
    'journey.pastAwareness.subtitle': 'Revisit the inner posture you recorded across recent days.',
    'journey.pastAwareness.empty': 'No mood entries have been saved yet.',
    ...
    'journey.dayDetail.readOnlyPast': 'You cannot add a new entry to a past day from here.',
    ...
    'reflection.subtitle.midweek': 'MIDWEEK CHECKPOINT',
    'reflection.invitation.dailyLabel': 'DAILY INVITATION',
    'reflection.invitation.midweekLabel': 'MIDWEEK CHECKPOINT',
    'reflection.invitation.dailyText': '"What stayed with you today?"',
    'reflection.invitation.midweekText': '"What has become clearer as this week has unfolded?"',
    ...
    'mood.label.heavy': 'Heavy',
    'mood.label.longing': 'Longing',
    'mood.descriptor.peaceful': 'settled, trusting, at rest',
    'mood.descriptor.rushed': 'pressured, crowded, hurried',
    'mood.descriptor.anxious': 'uneasy, fearful, unsettled',
    'mood.descriptor.grateful': 'thankful, receptive, aware of grace',
    'mood.descriptor.tired': 'drained, worn, low on strength',
    'mood.descriptor.heavy': 'burdened, weighed down, carrying a lot',
    'mood.descriptor.longing': 'hungry for God, reaching for renewal',
    ...
    'moodDetail.title.heavy': 'Heavy',
    'moodDetail.title.longing': 'Longing',
    ...
    'moodDetail.desc.heavy': 'You marked this moment as heavy. Something felt weighty enough to carry in your body and spirit. This posture is not weakness; it is an honest signal that you may need rest, prayer, and the steady nearness of God.',
    'moodDetail.desc.longing': 'You marked this moment as longing. There was a holy ache in you, a desire for more of God than your current moment seemed to hold. This posture can be tender, but it often becomes the place where deeper renewal begins.',
  ...
  es: {
    ...
    'actions.churchMessageNotPublishedBody': 'El mensaje de esta semana todavía no se ha publicado dentro de la app.',
    ...
    'actions.audioUnavailableBody': 'La reproducción de audio todavía no está disponible en esta versión.',
    ...
    'auth.footer.terms': 'Términos de Uso',
    ...
    'legal.terms.s1.title': 'Qué es MKP',
    'legal.terms.s1.body': 'MKP es una app de formación espiritual dirigida por la iglesia, diseñada para ayudar a las iglesias a extender la enseñanza del domingo al resto de la semana mediante reflexión, formación y conexión de cuidado.',
    'legal.terms.s2.title': 'No es Atención de Emergencia, Médica ni de Crisis',
    'legal.terms.s2.body': 'MKP no es respuesta a emergencias, terapia, atención médica ni intervención en crisis. Si alguien está en peligro inmediato o necesita ayuda urgente, contacta a los servicios de emergencia locales u otro recurso de emergencia apropiado.',
    'legal.terms.s3.title': 'Uso Aceptable',
    'legal.terms.s3.body': 'Aceptas no hacer un uso indebido de MKP, no interferir con el servicio, no intentar acceso no autorizado, no suplantar a otros ni usar la app de una manera que viole la ley aplicable o la seguridad y confianza de los demás.',
    'legal.terms.s4.title': 'Reflexión Privada y Envíos a la Iglesia',
    'legal.terms.s4.body': 'Las entradas de journal, los estados de ánimo y el texto de reflexión privada están diseñados para permanecer en tu dispositivo como parte de la experiencia prevista del producto. Si envías intencionalmente una solicitud de oración, apoyo u otra solicitud dirigida a la iglesia, ese contenido puede compartirse con el equipo de tu iglesia para seguimiento ministerial.',
    'legal.privacy.title': 'Política de Privacidad',
    'legal.privacy.s1.title': 'Qué Permanece en tu Dispositivo',
    'legal.privacy.s1.body': 'Las entradas de journal, los estados de ánimo y el texto de reflexión están diseñados para permanecer en tu dispositivo y no almacenarse en la infraestructura backend de MKP como parte de la experiencia principal del producto.',
    'legal.privacy.s2.title': 'Solicitudes de Apoyo de la Iglesia',
    'legal.privacy.s2.body': 'Si decides enviar una solicitud de oración, apoyo, gratitud u otra solicitud dirigida a la iglesia a través de Cuidado, ese contenido puede ponerse a disposición del equipo de tu iglesia para seguimiento. Estas solicitudes no son públicas y no se publican en un muro de oración ni en un feed comunitario.',
    'legal.privacy.s3.title': 'Respaldos y Datos de la Iglesia',
    'legal.privacy.s3.body': 'Como el contenido de reflexión local permanece en tu dispositivo, aún puede verse afectado por la configuración de respaldo de tu dispositivo, como iCloud Backup o el respaldo del dispositivo Android. Los datos de la iglesia están pensados para permanecer dentro del contexto de la iglesia correspondiente y no compartirse entre iglesias no relacionadas.',
    'legal.privacy.s4.title': 'Tus Decisiones y los Límites de MKP',
    'legal.privacy.s4.body': 'Tú decides qué escribes en privado en tu dispositivo y qué envías intencionalmente a través de los flujos de la iglesia. MKP no está diseñado como una plataforma social pública, un muro público de oración ni un sistema de notas pastorales.',
    ...
    'legal.openOnline': 'VER LA VERSIÓN COMPLETA EN LÍNEA',
    ...
    'settings.language.fr': 'Français',
    'settings.language.pt': 'Português',
    'settings.language.comingSoon': 'Próximamente',
    'settings.language.supportedNote': 'Hoy solo inglés y español están totalmente disponibles. Más idiomas aparecerán aquí cuando la app esté completamente traducida.',
    ...
    'settings.care.messagesFeed': 'Bandeja de Mensajes de la Iglesia',
    'settings.care.messagesFeedHint': 'Lee avisos pastorales y actualizaciones generales solo de entrada.',
    ...
    'settings.care.inbox': 'Bandeja de Cuidado',
    'settings.care.inboxHint': 'Revisa hilos privados de seguimiento pastoral dentro de la app.',
    ...
    'care.home.nextStep': 'DAR UN PRÓXIMO PASO',
    ...
    'care.home.inbox': 'VER BANDEJA DE CUIDADO',
    'care.home.messages': 'MENSAJES DE LA IGLESIA',
    ...
    'care.support.type.unsure': 'No estoy seguro de cuál es mi próximo paso',
    'care.nextSteps.title': '¿Qué próximo paso te gustaría dar?',
    'care.nextSteps.section.type': 'ELIGE UN PRÓXIMO PASO',
    'care.nextSteps.section.message': 'TU NOTA',
    'care.nextSteps.section.messageOptional': 'TU NOTA (OPCIONAL)',
    'care.nextSteps.section.contact': 'PREFERENCIA DE SEGUIMIENTO',
    'care.nextSteps.placeholder': 'Comparte cualquier detalle útil para tu iglesia...',
    'care.nextSteps.placeholderOptional': 'Algo que quieras que tu iglesia sepa (opcional)...',
    'care.nextSteps.defaultMessage.new_believer': 'Se solicitó seguimiento por nueva salvación.',
    'care.nextSteps.defaultMessage.baptism_request': 'Se solicitó seguimiento para bautismo.',
    'care.nextSteps.defaultMessage.other': 'Se solicitó seguimiento para próximo paso.',
    'care.nextSteps.send': 'ENVIAR PRÓXIMO PASO',
    'care.nextSteps.sending': 'Enviando tu próximo paso...',
    'care.nextSteps.error': 'Algo salió mal. Es posible que tu próximo paso no se haya enviado.',
    'care.nextSteps.retry': 'INTENTAR DE NUEVO',
    'care.nextSteps.saveLocal': 'GUARDAR LOCALMENTE',
    'care.nextSteps.saved.title': 'Guardado en este dispositivo',
    'care.nextSteps.saved.body': 'Tu próximo paso quedó guardado localmente por ahora. Puedes enviarlo más tarde.',
    'care.nextSteps.contactNote': 'El seguimiento permanece en la app cuando esté disponible. Tu iglesia también puede usar el correo de tu cuenta si hace falta.',
    ...
    'care.success.viewInbox': 'VER BANDEJA DE CUIDADO',
    'care.success.returnHome': 'VOLVER AL INICIO',
    'care.success.submitPrayer': 'ENVIAR UNA ORACIÓN',
    'care.nextSteps.success.kicker': 'PRÓXIMO PASO',
    'care.nextSteps.success.title': 'Tu próximo paso fue compartido.',
    'care.nextSteps.success.message': 'Tu iglesia ya recibió tu solicitud de próximo paso y puede dar seguimiento según su flujo ministerial.',
    'care.nextSteps.success.disclaimer': 'Si estás en peligro inmediato, llama a los servicios de emergencia locales.',
    'care.nextSteps.success.returnHome': 'VOLVER AL INICIO',
    'care.nextSteps.success.submitPrayer': 'ENVIAR UNA ORACIÓN',
    'care.inbox.title': 'Bandeja de Cuidado',
    'care.inbox.subtitle': 'El seguimiento privado de tu equipo pastoral aparecerá aquí.',
    'care.inbox.emptyTitle': 'Todavía no hay hilos de cuidado.',
    'care.inbox.emptyBody': 'Cuando envíes una solicitud de apoyo y elijas seguimiento en la app, tu hilo privado aparecerá aquí.',
    'care.inbox.status.awaiting': 'Esperando respuesta',
    'care.inbox.status.closed': 'Cerrado',
    'care.thread.sender.you': 'Tú',
    'care.thread.sender.church': 'Equipo de Iglesia',
    'care.thread.status.awaitingTitle': 'Esperando una respuesta',
    'care.thread.status.awaitingBody': 'Cuando tu iglesia responda en la app, aparecerá en este hilo privado.',
    'care.thread.status.closedTitle': 'Hilo completo',
    'care.thread.status.closedBody': 'Tu iglesia ya envió su única respuesta dentro de la app para esta solicitud.',
    'care.thread.oneReplyRule': 'Una sola respuesta de la iglesia mantiene el apoyo enfocado y la app centrada en la formación.',
    'care.thread.missingTitle': 'Hilo no disponible',
    'care.thread.missingBody': 'No se pudo encontrar este hilo de cuidado en este dispositivo.',
    'care.preference.encouragementOff': 'Las respuestas de ánimo están desactivadas en Configuración, por lo que esta solicitud no abrirá un hilo privado de seguimiento.',
    'churchMessages.title': 'Mensajes de la Iglesia',
    'churchMessages.subtitle': 'Aquí aparecen avisos pastorales, recordatorios y mensajes generales solo de entrada.',
    'churchMessages.offTitle': 'Los mensajes de la iglesia están en pausa.',
    'churchMessages.offBody': 'Activa Mensajes de la Iglesia en Configuración cuando quieras recibir comunicaciones generales dentro de la app.',
    'churchMessages.missingTitle': 'Mensaje no disponible',
    'churchMessages.missingBody': 'No se pudo abrir este mensaje de la iglesia en este momento.',
    'churchMessages.kind.pastoral': 'Nota Pastoral',
    'churchMessages.kind.announcement': 'Anuncio',
    'churchMessages.kind.reminder': 'Recordatorio',
    ...
    'journey.quick.insights': 'INSIGHTS SEMANALES',
    'journey.quick.awareness': 'RITMO DE ESTADO',
    'journey.search.placeholder': 'Busca reflexiones, estados o sermones',
    'journey.search.empty': 'Todavía no hay entradas que coincidan con esta búsqueda.',
    'journey.pastAwareness.title': 'Awareness Pasada',
    'journey.pastAwareness.subtitle': 'Vuelve a ver la postura interior que registraste en los últimos días.',
    'journey.pastAwareness.empty': 'Todavía no hay estados guardados.',
    ...
    'journey.dayDetail.readOnlyPast': 'No puedes agregar una nueva entrada a un día pasado desde aquí.',
    ...
    'reflection.subtitle.midweek': 'PAUSA DE MITAD DE SEMANA',
    'reflection.invitation.dailyLabel': 'INVITACIÓN DIARIA',
    'reflection.invitation.midweekLabel': 'PAUSA DE MITAD DE SEMANA',
    'reflection.invitation.dailyText': '"¿Qué permaneció contigo hoy?"',
    'reflection.invitation.midweekText': '"¿Qué se ha vuelto más claro mientras avanzó esta semana?"',
    ...
    'mood.label.heavy': 'Cargado',
    'mood.label.longing': 'Anhelo',
    'mood.descriptor.peaceful': 'en descanso, confiado, sereno',
    'mood.descriptor.rushed': 'apurado, presionado, acelerado',
    'mood.descriptor.anxious': 'inquieto, temeroso, alterado',
    'mood.descriptor.grateful': 'agradecido, receptivo, consciente de la gracia',
    'mood.descriptor.tired': 'agotado, desgastado, sin fuerzas',
    'mood.descriptor.heavy': 'cargado, abrumado, llevando mucho peso',
    'mood.descriptor.longing': 'hambriento de Dios, buscando renovación',
    ...
    'moodDetail.title.heavy': 'Cargado',
    'moodDetail.title.longing': 'Anhelo',
    ...
    'moodDetail.desc.heavy': 'Marcaste este momento como cargado. Algo se sintió lo bastante pesado como para notarlo en tu cuerpo y en tu espíritu. Esta postura no es debilidad; es una señal honesta de que quizá necesitas descanso, oración y la cercanía constante de Dios.',
    'moodDetail.desc.longing': 'Marcaste este momento como anhelo. Había en ti un hambre santa, un deseo de más de Dios de lo que este momento parecía contener. Esta postura puede ser tierna, pero a menudo es el lugar donde comienza una renovación más profunda.',
...
const LOCALE_KEY = 'mkp.locale';
const LOCALE_OVERRIDE_KEY = 'mkp.locale.override';

const getDefaultLocale = (): SupportedLocale => {
  const hasExplicitOverride = Settings.get(LOCALE_OVERRIDE_KEY) === true;
  const savedLocale = Settings.get(LOCALE_KEY);
  if (hasExplicitOverride && (savedLocale === 'en' || savedLocale === 'es')) {
    return savedLocale;
  }
