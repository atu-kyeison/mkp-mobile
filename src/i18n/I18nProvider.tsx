...
const dictionaries: Record<SupportedLocale, Dictionary> = {
  en: {
    ...
    'care.support.contactNote': 'We will follow up in-app, and by account email when needed.',
    'care.support.contactValue.call': 'PHONE NUMBER',
    'care.support.contactValue.text': 'MOBILE NUMBER',
  ...
  es: {
    ...
    'care.support.contactNote': 'Daremos seguimiento en la app y, cuando sea necesario, por el correo de tu cuenta.',
    'care.support.contactValue.call': 'NÚMERO DE TELÉFONO',
    'care.support.contactValue.text': 'NÚMERO MÓVIL',
